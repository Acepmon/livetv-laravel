...
@php
    $typeClasses = match ($type) {
        'primary' => 'bg-primary-600 dark:bg-primary-600 text-white dark:text-white hover:bg-primary-500 dark:focus:ring-offset-primary-900 dark:focus:ring-primary-100 dark:hover:bg-primary-500 focus:ring-2 focus:ring-primary-900 focus:ring-offset-2',
