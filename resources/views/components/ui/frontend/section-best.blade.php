        ...
        <div class="flex items-end p-6">
          <div>
            ...
            <div class="flex flex-row gap-1.5 items-center mt-1">
              <p aria-hidden="true" class="text-base text-white">The Beatles</p>
              <span class="text-white text-sm">•</span>
              <p aria-hidden="true" class="text-sm text-white">54K Views</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="group aspect-w-16 aspect-h-10 overflow-hidden rounded-lg relative">
        ...
        <div class="flex items-end p-6 sm:absolute sm:inset-0">
          <div>
            ...
            <div class="flex flex-row gap-1.5 items-center mt-1">
              <p aria-hidden="true" class="text-base text-white">20th Century Studios</p>
              <span class="text-white text-sm">•</span>
              <p aria-hidden="true" class="text-sm text-white">320K Views</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="flex items-end p-6 sm:absolute sm:inset-0">
          <div>
            <h3 class="font-semibold text-white">
              <a href="{{ route('movie') }}">
                <span class="absolute inset-0"></span>
                Fortnite Chapter 4: Season OG - Return to Tilted Towers
              </a>
            </h3>
            <div class="flex flex-row gap-1.5 items-center mt-1">
              <p aria-hidden="true" class="text-base text-white">Fortnite</p>
              <span class="text-white text-sm">•</span>
              <p aria-hidden="true" class="text-sm text-white">71K Views</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="group aspect-w-16 aspect-h-10 overflow-hidden rounded-lg relative">
        ...
        <div class="flex items-end p-6">
          <div>
            ...
            <div class="flex flex-row gap-1.5 items-center mt-1">
              <p aria-hidden="true" class="text-base text-white">Good Good</p>
              <span class="text-white text-sm">•</span>
              <p aria-hidden="true" class="text-sm text-white">1.3K Views</p>
            </div>
          </div>
        </div>
      </div>
